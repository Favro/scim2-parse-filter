...
const test = (text, e) => {
    it(text, () => {
        chai_1.assert.deepEqual((0, src_1.parse)(text), e);
    });
};
describe('parse', () => {
    describe("logic", () => {
        ...
        function teq(e, a) {
            chai_1.assert.deepEqual(to_s(a), to_s((0, src_1.parse)(e)), e);
        }
    ...
    describe('operator ignore case', () => {
        test(`hoge Eq "hoge"`, (0, test_util_1.eq)("hoge", "hoge"));
    });
    describe("samples", () => {
        ...
        test(`emails[type eq "work"] and emails.value eq "user@example.com"`, (0, test_util_1.and)((0, test_util_1.v)("emails", (0, test_util_1.eq)("type", "work")), (0, test_util_1.eq)("emails.value", "user@example.com")));
        test(`emails[type eq "work"].value eq "user@example.com"`, (0, test_util_1.and)((0, test_util_1.v)("emails", (0, test_util_1.eq)("type", "work")), (0, test_util_1.eq)("emails.value", "user@example.com")));
        test(`emails[type eq "work"].value eq "user@example.com" and name eq "foo"`, (0, test_util_1.and)((0, test_util_1.and)((0, test_util_1.v)("emails", (0, test_util_1.eq)("type", "work")), (0, test_util_1.eq)("emails.value", "user@example.com")), (0, test_util_1.eq)("name", "foo")));
